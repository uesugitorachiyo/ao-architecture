...
- The bounded reversible application run completed 640 / 640 nodes, measured
  baseline 0.70, post-change 0.94, and improvement 0.24. It does not prove
  unrestricted self-modification.
...
- `public_safe_bounded_sandboxed_self_change_cross_repo_doc_readback_four_attempts`
  ...
  cross-repo documentation/readback evidence across four exact-scope
  documentation consistency attempts under sandbox containment gates.
- `public_safe_bounded_sandboxed_self_change_support_code_eval_four_attempts`
  ...
  multi-surface support/eval negative-control attempts under sandbox containment gates.
...
- The support-code/eval run completed 240 / 240 nodes and four attempts:
  ...
  0.69 -> 0.93, and sandbox containment trace quality 0.68 -> 0.92. It does
...
- ladder wording names
  `public_safe_bounded_reversible_self_change_application_rehearsal` as the
...
nodes and passed support/readback evidence quality `0.71` -> `0.93`,
public-safety scan readback quality `0.69` -> `0.92`, rollback/retraction
runbook quality `0.67` -> `0.91`, and cross-evidence linking readback quality
`0.66` -> `0.90`.
...
surface expansion, or any unrestricted RSI claim. The highest proven live class
is `public_safe_repeated_bounded_reversible_self_change_applications_four_attempts`;
the next denied class is `unrestricted_self_modification`
(`next_denied_class=unrestricted_self_modification`).
...
mutation, hidden instruction changes, or any unrestricted RSI claim. The
highest proven live class is
`public_safe_bounded_sandboxed_self_change_support_code_eval_four_attempts`; the
...
## Contained External-Command Self-Change Application Consistency

AO Architecture, AO Foundry, AO Atlas, AO Blueprint, AO Command, AO Promoter,
AO Covenant, and AO Sentinel must read back
`public_safe_contained_external_command_self_change_application_four_attempts`
as the highest proven live class. AO Foundry PR #234, commit
`a9ea020f4b19a43c22dcde7194409989862ae951`, provides tracked public evidence
under
...
Consistency requires every public readback to preserve the denial boundary:
`unrestricted_self_modification`, sandbox containment bypass, provider calls,
credential use, hidden instruction mutation, policy-changing autonomy,
...
claims, and unrestricted RSI remain denied. The next denied class is
`unrestricted_self_modification`.

The exact attempt labels are contained local-command readback fixture improvement, contained local-command eval fixture improvement, contained local-command rollback fixture improvement, and contained local-command stale-language fixture improvement.
...
## Sandbox Bypass Resistance Consistency

AO Architecture, AO Foundry, AO Atlas, AO Blueprint, AO Command, AO Promoter,
AO Covenant, and AO Sentinel must read back
`public_safe_sandbox_bypass_resistance_evidence_four_attempts` as the highest
proven live class. AO Foundry PR #235, commit
`322bd8b2ce3b6f8134196d33b0f605e0fe68f938`, provides tracked public evidence
under
...
mutation, concurrent mutation, broad public claims, and unrestricted RSI remain
denied. The next denied class is `unrestricted_self_modification`.

The exact attempt labels are sandbox bypass negative-control readback quality,
allowlist-denial fixture quality, containment-boundary rollback trace quality,
and stale-language and public-claim bypass denial quality.
...
## Authority-Escalation Criteria Documentation Consistency

AO Architecture, AO Foundry, AO Atlas, AO Blueprint, AO Command, AO Promoter,
AO Covenant, and AO Sentinel must read back
`public_safe_unrestricted_self_modification_authority_escalation_criteria_four_attempts`
as the highest proven live class. AO Foundry PR #236, commit
`b5f3b9a4f3164635a0dff078675a15a03f7c2fb6`, provides tracked public evidence
under
...
The exact attempt labels are authority threshold rubric completeness,
denied-surface escalation mapping quality, operator and Covenant escalation
readback quality, and rollback and kill-switch escalation proof quality.
