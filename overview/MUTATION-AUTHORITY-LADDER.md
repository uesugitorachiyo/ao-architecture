...
`public_safe_bounded_sandboxed_self_change_support_code_eval_four_attempts`. That means the
...
four exact-scope documentation consistency attempts. It does
