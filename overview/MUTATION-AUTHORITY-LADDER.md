...
`public_safe_bounded_recursive_improvement_review_durability_evidence`. That means the
...
bounded wording generality, and bounded recursive-improvement review durability.
