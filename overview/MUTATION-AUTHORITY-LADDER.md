...
`public_safe_bounded_sandboxed_self_change_applications_non_readback_four_attempts`. That means the
...
bounded reversible support/readback attempts, and bounded sandboxed
