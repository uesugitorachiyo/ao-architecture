...
`public_safe_bounded_sandboxed_self_change_sandbox_boundary_stress_four_attempts`. That means the
...
four exact-scope documentation consistency attempts, bounded sandboxed support-code/eval evidence across four exact-scope reversible attempts, bounded sandboxed multi-surface support/eval negative-control evidence across four exact-scope reversible attempts, and bounded sandboxed delegated dry-run authority-gap evidence across four exact-scope reversible attempts, and bounded sandboxed self-change sandbox-boundary stress evidence across four exact-scope reversible attempts. It does
