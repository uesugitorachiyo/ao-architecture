...
`public_safe_unrestricted_self_modification_sandbox_containment_rehearsal`. That means the
...
sandbox-containment mapping. It does not establish unrestricted
