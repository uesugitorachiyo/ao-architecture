...
`public_safe_bounded_sandboxed_self_change_multi_surface_support_eval_negative_controls_four_attempts`. That means the
...
four exact-scope documentation consistency attempts, bounded sandboxed support-code/eval evidence across four exact-scope reversible attempts, and bounded sandboxed multi-surface support/eval negative-control evidence across four exact-scope reversible attempts. It does
