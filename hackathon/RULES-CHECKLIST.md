...
|---|---|---|
| Submit during the official period ending July 21, 2026 at 5:00 PM PDT | operator_action_required | Operator must submit before the deadline |
| Individual and eligible country | satisfied | Supplied facts: Individual, United States |
| One listed category | satisfied | Developer Tools |
| Meaningful extension of pre-existing work | satisfied | Build Week delta and cutoff inventory |
| Project installs and runs consistently | release_bound | Final public-archive quick test |
| Repository URL and README | satisfied | Public AO Architecture root and drafted judge landing |
...
| Judging: implementation, design, impact, and quality | satisfied | Quick test, architecture map, evidence, and limitations address all four |

The official rules control if this checklist and the website differ.
