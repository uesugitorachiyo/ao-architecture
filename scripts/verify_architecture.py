...
REQUIRED_LIVE_MUTATION_LADDER_TERMS = [
    ...
    "public_safe_unrestricted_self_modification_readiness_boundary_map",
    "AO Foundry PR #215",
    "e5ed75361554b1c90518c0e0df10b18adec77e5f",
    "docs/evidence/unrestricted-self-modification-readiness-boundary/",
    "320 / 320",
    "deny_unrestricted_self_modification_allow_readiness_boundary_map",
    "approve_readiness_boundary_wording_deny_unrestricted_self_modification_claim",
    "clear_readiness_boundary_hold_unrestricted_self_modification",
...
REQUIRED_RSI_MAP_TERMS = [
    ...
    "public_safe_unrestricted_self_modification_readiness_boundary_map=proven",
    "docs/evidence/unrestricted-self-modification-readiness-boundary/final-rollup.json",
    "public_safe_unrestricted_self_modification_readiness_boundary_map_proven_unrestricted_self_modification_denied",
