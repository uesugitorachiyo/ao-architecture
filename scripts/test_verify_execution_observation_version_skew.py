...
NOW = datetime(2026, 8, 11, 11, 50, tzinfo=timezone.utc)
...
class VersionSkewContractTest(unittest.TestCase):
    ...
    def test_binds_final_v0511_candidate_heads(self):
        ...
        self.assertEqual(candidate["ao2_source_sha"], "269b7e8e5901f1984fae7f9d2c11144e67d958b3")
    ...
    def test_rejects_stale_timestamp(self):
        stale = datetime(2026, 8, 13, tzinfo=timezone.utc)
    ...
    def test_rejects_future_generation_time(self):
        candidate = valid_contract()
        candidate["generated_at"] = "2026-08-11T12:00:00Z"
    ...
    def test_expires_at_exact_boundary(self):
        boundary = datetime(2026, 8, 12, 11, 46, tzinfo=timezone.utc)
