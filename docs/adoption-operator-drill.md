...
consumer tests. All 16 edges are fresh; the native AO2 v0.5.10 execution-to-observation
vector and Control Plane v0.1.19 consumer test bind the current public pair. The compatibility gate is
