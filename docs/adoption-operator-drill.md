...
The current public pair is AO2 v0.5.11 and AO2 Control Plane v0.1.19.
...
v0.5.11 to the native AO2 v0.5.10 execution-to-observation vector and Control Plane v0.1.19 consumer test. The compatibility gate is
