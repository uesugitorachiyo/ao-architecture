...
The current public pair is AO2 v0.5.9 and AO2 Control Plane v0.1.19.

The compatibility matrix has 16 tested edges, 16 canonical vectors, and 16
consumer tests. All 16 edges are fresh; the AO2 v0.5.9 execution-to-observation
vector binds AO2 v0.5.9 and Control Plane v0.1.19. The compatibility gate is
